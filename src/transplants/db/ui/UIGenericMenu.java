...
public class UIGenericMenu {
	...
	public UIGenericMenu() {
		...
		try {
			 ...
			 * if(drop.equalsIgnoreCase("Y")){ boolean dropped =
			 ...
			 * 
			 * //database creation
			 * System.out.println("Create database? [yes/no]"); String data =
			 * console.readLine(); if(data.equals("yes")){ boolean
			 * createDatabase = jpaManager.createDatabase(database); //boolean
			 * createDatabase = dbManager.createDatabase(database); if
			 * (createDatabase){
			 * System.out.println("Database has been created. "); } else{
			 * System.out.println("Database hasn't been created. "); } }else{
			...
			while (true) {
				...
				case 1: {
					...
					case 4:
						...
						//List<Animal_tissue> animal=new ArrayList<>();
						while (it.hasNext()){
							Requested_organ organ=it.next();
							if(organ.getName().equalsIgnoreCase("collagen")){
						...
						if (animalT.equalsIgnoreCase("yes")) {
							...
							System.out.println(
									"Please, introduce the following information in order to compleate the request.");
						...
						String organ = console.readLine();
						if (organ.equalsIgnoreCase("animal")) {
							uiAnimalT.introduceNewAnimalTissue(reqOrg, dbManager);
						...
						if (counterPat != 1) {
							...
							case 4:
								...
								if (reqs != null) {
									...
									switch (opOrgan) {
									case 1:
										List<Requested_organ> reqOrg = uiRequested.introduceNewReqOrgan(patReq,
												dbManager, jpaManager);

										System.out.println(
												"Did the patient need skin or collagen transplantation? [yes/no]");
	                    	...
	                    	case 4:
	                    		...
	                    		switch (opPat){
	                    			...
	                    			case 4:
	                    				...
	                    				int numPat4 = Integer.parseInt(console.readLine());
	                    				Patient patReq = pat.get(numPat4-1);
	                    				//TODO mirar como esta gecho donor, se puede hacer m�s simple
	                    				...
	                    				if (reqs!=null){
            	                    		...
            	                    		switch(opOrgan){
            	                    			...
            	                    			case 2: 
            	                    				...
            	                    				//TODO Podriamos ponerle que despues de que haya actualizo la info se la muestre 
            	                    				//al usuario y que aqui le diga si le ha tocado organo de animal o de persona???
            	                    			break;
									...
									case 2:
										// INTRODUCIR REQORGAN QUE L USUARIO
										// META PRIMERO DE ANIMAL O DE PERSONA
										System.out.println("Introduce the number of the organ: ");
										numOrg = Integer.parseInt(console.readLine());
										Requested_organ orgDe = reqs.get(numOrg - 1);
										uiRequested.deleteRequestOrgan(orgDe, dbManager);
